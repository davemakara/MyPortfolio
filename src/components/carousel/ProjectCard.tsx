  ...
  return (
    <div className="group">
      <Link to={project.id}>
        ...
        <div className="absolute top-full group-hover:-translate-y-full transition-transform duration-300 bg-opacity-90 w-full h-3/5 bg-black p-3 sm:p-6 md:p-8 xxl:p-12 tracking-wide">
