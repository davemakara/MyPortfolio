  ...
  return (
    <div className="group">
      <Link to={project.id}>
        ...
        <MdOutlineSwipeRight className="absolute top-3 md:top-5 right-3 md:right-5 text-4xl md:text-6xl lg:text-5xl xxl:text-7xl text-white animate-rotate-back-forth" />
        <MdOutlineSwipeLeft className="absolute top-3 md:top-5 left-3 md:left-5 text-4xl md:text-6xl lg:text-5xl xxl:text-7xl text-white animate-rotate-back-forth" />
